...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, navParams, storage) {
        ...
        this.storage.get('location').then(function (val) {
            if (val != null) {
                ...
                _this.country = location_1.country;
            }
            else {
                _this.city = 'Miami';
                _this.country = 'FL';
    ...
    HomePage.prototype.saveDatas = function () {
        var location = {
            city: this.city,
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/kande-abdoul/Documents/cours perso/Application/Ionic/Demo/src/pages/home/home.html"*/'<!--\n  Generated template for the HomePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>home</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content scroll="false">\n  <ion-grid>\n    <ion-row>\n      <ion-col>\n         <ion-list>\n          <form (ngSubmit)="saveDatas()">\n            <ion-item>\n                <ion-label>\n                  Nom du pays\n                </ion-label>\n                <ion-input type="text" [(ngModel)]=\'country\' name=\'country\'></ion-input>\n              </ion-item>\n              <ion-item>\n                <ion-label>\n                  Region\n                </ion-label>\n                <ion-input type="text" [(ngModel)]=\'city\' name=\'city\'></ion-input>\n              </ion-item>\n            <button ion-button type="submit" block>Rechercher</button>\n          </form>\n         </ion-list>\n       </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"/home/kande-abdoul/Documents/cours perso/Application/Ionic/Demo/src/pages/home/home.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_provider_provider__ = __webpack_require__(197);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__providers_provider_provider__["a" /* Provider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/kande-abdoul/Documents/cours perso/Application/Ionic/Demo/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/kande-abdoul/Documents/cours perso/Application/Ionic/Demo/src/app/app.html"*/
        }),
